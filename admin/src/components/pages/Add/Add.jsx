...
const Add = () => {
    ...
    const omnSubmitHandler = async (event) => {
        ...
        const response = await axios.post(`${url}/api/food.add`)  //this is the endpoint for uploading product
    ...
    <div className='add'>
        <form className='flex-col' onSubmit={omnSubmitHandler}>
            ...
            <div className="add-product-dicription flex-col">
                ...
                <textarea onChange={onChangeHandler} name="discription"  rows='6' placeholder='Write your description here' required> </textarea>
            </div>
